<template>
  <div class="catalog__buttons">
    <div class="catalog__actions">
      ...
      <!--                       @click="like()"/>-->
      <button-call @click="call" class="button--call-green"/>
      <!--<button-compare v-if="long" />-->
    </div>
    <div class="catalog__actions-main catalog__actions-main--long"
         v-if="long">
      ...
      <button-typical v-else
                      @click="credit()"
                      :text="`В кредит за ${creditPrice(offer.price)}`"
                      button-class="button--credit"/>
    </div>
    <div class="catalog__actions-main" v-else>
      <button-typical v-if="choose"
                      @click="chooseClick(offer)"
