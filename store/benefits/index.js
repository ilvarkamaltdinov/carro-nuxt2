export const state = () => ({
    ...
    benefits: [
        ...
        },
        {
            ...
            text_strong: 'до 300 000 ₽',
            icon: 'bank',
            description: 'При обмене автомобиля по по программе Trade-In через CARRO Вам предоставляется скидка до 300 000 ₽ от изначальной стоимости нового автомобиля.',
            slug: 'sale-trade',
        },
        {
            text: 'Автокредит',
