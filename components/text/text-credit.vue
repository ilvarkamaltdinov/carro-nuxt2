				...
				<div class="text__figure figure">
					<picture>
						<source type="image/webp"
						        ...
						        srcset="`~/static/img/figures/figure-2@1x.webp 1x, ~/static/img/figures/figure-2@2x.webp 2x" />
						<source media="(min-width: 768px)"
						        srcset="~/static/img/figures/figure-2@1x.png 1x, ~/static/img/figures/figure-2@2x.png 2x" />
						<img class="text__figure-img"
						     src="~/static/img/figures/figure-2@1x.png"
						     srcset="~/static/img/figures/figure-2@2x.png 2x"
						     loading="lazy"
						     alt="" />
					</picture>
				</div>
