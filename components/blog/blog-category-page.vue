<template>
  <section class="page-main__blog blog grid">
    ...
    <div class="blog__wrap grid__col-12">
      <ul class="blog__list">
        <li class="blog__item" v-for="item in list" :key="item.id">
          <nuxt-link :to="item.url" class="blog__link">
      ...
      <client-only>
        <infinite-loading @infinite="getArticles" :throttle-limit="2500">
