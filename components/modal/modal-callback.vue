    ...
    <div class="modal__wrap">
      ...
      <div class="application application--modal grid__col-12 grid grid--application grid--application-modal">
        <div class="application__form grid__col-4">
          <div class="text">
            <p class="text__p text__p--modal">Операторы работают <span class="text__working-hours">с 9:00 до 21:00</span>. Оставьте заявку, и мы с радостью перезвоним вам в рабочее
              время!</p>
          </div>
        ...
        <div class="application__catalog application__catalog--modal catalog grid__col-4">
          <component :is="$device.isMobile ? 'catalog-item-large-mobile':'catalog-item-small-desktop'"
            v-if="!$device.isMobile && modalData.mark" :is-form="true" :has-buttons="false" :offer="modalData" />
