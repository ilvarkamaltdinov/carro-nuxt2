<template>
	<article class="catalog__item catalog__item--desktop-l catalog__item--desktop-form">
		<div class="catalog__img">
			<div class="swiper">
				<div class="swiper-wrapper">
					<catalog-item-img :key="img"
					                  :img="img"
					                  v-for="img in catalogItemImgCount" />
				</div>
			</div>
