  ...
  computed: {
    ...
    slides() {
      return [
        {
          id: 10,
          heading: `Черная пятница на carro.ru`,
          content:
            "Дополнительная скидка 10% на любой автомобиль за заявку на автокредит",
          link: "/credit",
        },
        {
          id: 6,
          ...
          content:
            "Скидка до 150 000 ₽, одобрение по паспорту и В/У, взнос от 0%",
          link: "/credit",
        },
        {
          id: 7,
